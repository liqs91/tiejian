<template>
  <div v-if="theme.layout=='common'" class="vue-admin-beautiful-wrapper-common" :class="classObj">
    <component
  ...
  <div v-else class="vue-admin-beautiful-wrapper" :class="classObj">
    <component
      :is="'vab-layout-' + theme.layout"
      :collapse="collapse"
      :device="device"
...
<style lang="scss" scoped>
  .vue-admin-beautiful-wrapper-common {
    position: relative;
    width: 100%;
    height: 100%;
    ...
    :deep() {
      ...
      .vab-main {
        ...
        &.is-collapse-main {
          margin-left: $base-left-menu-width-min-common;

          .fixed-header {
            left: $base-left-menu-width-min-common;
            width: calc(100% - #{$base-left-menu-width-min-common});
          }
        }
      }
    }
